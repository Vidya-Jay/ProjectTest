...
public class Table_example {
	...
	public void launch(){
		...
		driver.navigate().to("http://content.icicidirect.com");
		driver.manage().window().maximize();
	}
	@Test
	public void Verify_table() throws InterruptedException{
...
//click on marketsstatus link
WebElement marketsstatus=driver.findElement(By.xpath(".//*[@id='LiMarketStats']/a"));
wait.until(ExpectedConditions.elementToBeClickable(marketsstatus));
ac.moveToElement(marketsstatus).click().perform();
Thread.sleep(3000);
//click on daily share price link
